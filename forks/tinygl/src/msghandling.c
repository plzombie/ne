...
// (plzombie) Why adding debug information and writing #define NODEBUG define? why not use project/makefiles? Anyway, NDEBUG already defined in vs release configuration
#ifndef NDEBUG
#define NDEBUG
#endif
